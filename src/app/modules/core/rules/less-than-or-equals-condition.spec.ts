import { LessThanOrEqualsCondition } from './less-than-or-equals-condition';
import { DataElementValues } from '../dataelementvalues';
import { ConditionType } from '../models/conditiontype.model';

describe('LessThanOrEqualsCondition Class', () => {

  let dataElementValues: DataElementValues;
  let conditionType: ConditionType;
  let instance: LessThanOrEqualsCondition;

  beforeEach(() => {
    createConditionsWithComparisonValueAsString();
    instance = new LessThanOrEqualsCondition(conditionType);
  });
  ...
  it('Created the LessThanOrEqualsCondition class', () => {
