import { GreaterThanCondition } from './greater-than-condition';
import { DataElementValues } from '../dataelementvalues';
import { ConditionType } from '../models/conditiontype.model';

describe('GreaterThanCondition Class', () => {

  let dataElementValues: DataElementValues;
  let conditionType: ConditionType;
  let instance: GreaterThanCondition;

  beforeEach(() => {
    createConditionsWithComparisonValueAsString();
    instance = new GreaterThanCondition(conditionType);
  });
  ...
  it('Created the GreaterThanCondition class', () => {
