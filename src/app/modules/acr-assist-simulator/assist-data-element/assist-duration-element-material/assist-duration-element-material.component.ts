...
@Component({
  selector: 'acr-assist-duration-element-material',
  templateUrl: './assist-duration-element-material.component.html',
  styleUrls: ['./assist-duration-element-material.component.css']
})
export class AssistDurationElementMaterialComponent implements OnInit, OnDestroy {
