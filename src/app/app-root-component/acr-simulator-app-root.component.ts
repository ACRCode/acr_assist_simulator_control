...
@Component({
  selector: 'acr-simulator-app-root',
  templateUrl: './acr-simulator-app-root.component.html',
  styleUrls: ['./acr-simulator-app-root.component.css']
})
export class AcrSimulatorAppRootComponent {
